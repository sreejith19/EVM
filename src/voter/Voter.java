...
public class Voter
{
    ...
    { 
        ...
        try
        {
            FileWriter f=new FileWriter("/home/user/Desktop/EVM-master/src//counter.txt");      //substitute path of text file here
                f.write(c);
                f.close();
        }
        catch(Exception e)
    ...
    private String getCounter()
    {
        ...
        try
        {
            FileReader f=new FileReader("/home/user/Desktop/EVM-master/src//counter.txt");      //substitute path of text file here
            for(int i=0;i<10;i++)
            {
                c[i]=(char)(f.read());
            }
