...
public class Party {
        ...
        boolean status = false;
          try{
              BufferedReader br = new BufferedReader(
                      new FileReader("/home/user/Desktop/EVM-master/src/party/"
                              + "partyid_counter.txt"));
          ...
          try{
              FileWriter w = new FileWriter("/home/user/Desktop/EVM-master/src/party/"
                              + "partyid_counter.txt");
    ...
    public static void main(String[] args) throws IOException{
       ...
       try(FileWriter out = 
               new FileWriter("/home/user/Desktop/EVM-master/src/party/party.txt",true))
       {
